/* NLZ Estudio — "Temporada de Decisiones" — generador de placas (estilo post + identidad NLZ) */
...
const lines = arr => arr.map(H).join('<br>');
...
{ id:'01_valor_cuanto-vale', wk:1, fmt:'Carrusel', day:'Mar 16 sep', date:'2026-09-16',
  ...
  tags:'#Córdoba #Inmobiliaria #Tasación #VenderMiCasa #NLZestudio',
  cta:'DM "TASACIÓN"',
  slides:[
    {t:'coverphoto', box:['Le pusiste precio','a tu casa.'], cta:'¿Pero es el precio real? →'},
    {t:'stmt', pre:'Arranquemos por lo incómodo:', big:['El precio no lo','pone tu bolsillo.'], color:'coral', post:'Lo pone el mercado.'},
    {t:'boxes', pre:'Lo que mueve el número de verdad:', items:['Ubicación real','Estado y mantenimiento','Papeles al día','El momento del mercado']},
    {t:'stmt', pre:'Y ojo con esto:', big:['Publicar caro','= meses','sin vender.']},
    {t:'stmt', pre:'La buena noticia:', big:['Tasar bien es','vender más rápido.'], color:'coral'},
    {t:'final', small:['¿Querés saber el número real de tu propiedad?'], big:['Te la taso','sin cargo.'], box:'Escribime TASACIÓN por DM.'},
  ]},
...
{ id:'02_valor_reel-senales', wk:1, fmt:'Reel', day:'Jue 18 sep', date:'2026-09-18',
  ...
  tags:'#Tasación #Córdoba #TipsInmobiliarios #VenderPropiedad #NLZestudio',
  cta:'Guardá + "agendá tu tasación" (link en bio)',
  ...
  slides:[
    {t:'reelhook', big:['3 señales de que','te tasaron mal.'], sub:'Guardá esto para cuando vendas 👇'},
  ]},
...
{ id:'03_valor_historia-menos', wk:1, fmt:'Carrusel', day:'Sáb 20 sep', date:'2026-09-20',
  ...
  tags:'#HistoriasDelOficio #Inmobiliaria #Córdoba #Confianza #NLZestudio',
  cta:'DM "quiero mi número real"',
  slides:[
    {t:'coverphoto', box:['Le dije que su casa','valía menos.'], cta:'Y me lo agradeció →'},
    {t:'stmt', pre:'Tenía en la mano', big:['otra tasación','inflada.'], post:'Para quedarse con la exclusiva.'},
    {t:'stmt', pre:'Le mostré los comparables reales de su cuadra.', big:['La cara','le cambió.'], color:'coral'},
    {t:'stmt', pre:'Ajustamos el precio con criterio,', big:['no con','miedo.']},
    {t:'stmt', big:['Se vendió','en 5 semanas.'], color:'coral', post:'Al valor que proyectamos.'},
    {t:'final', small:['Decir la verdad no cuesta la operación.'], big:['La','salva.'], box:'¿Querés tu número real? Escribime por DM.'},
  ]},

// ===== SEMANA 2 — SIN ERRORES =====
{ id:'04_errores_5-errores', wk:2, fmt:'Carrusel', day:'Mar 23 sep', date:'2026-09-23',
  ...
  tags:'#VenderMiCasa #ErroresComunes #Córdoba #Inmobiliaria #NLZestudio',
  cta:'Guardá + compartí · DM "vendo"',
  slides:[
    {t:'coverphoto', box:['Vender solo','parece más barato.'], cta:'Hasta que ves esto →'},
    {t:'stmt', num:'01', big:['Poner el precio','por lo que necesitás.'], post:'Y no por lo que vale.'},
    {t:'stmt', num:'02', big:['Fotos oscuras','y desordenadas.']},
    {t:'stmt', num:'03', big:['Publicar en todos','lados sin estrategia.']},
    {t:'stmt', num:'04', big:['Papeles a medias','que frenan la firma.'], color:'coral'},
    {t:'stmt', num:'05', big:['Marcar defectos','en cada visita.']},
...
{ id:'05_errores_reel-mito', wk:2, fmt:'Reel', day:'Jue 25 sep', date:'2026-09-25',
  ...
  tags:'#MitosInmobiliarios #Córdoba #PrecioDeVenta #Inmobiliaria #NLZestudio',
  cta:'Comentá "MITO" para la parte 2',
  ...
  slides:[
    {t:'reelhook', big:['"Lo pongo caro','y después bajo."'], sub:'Pará. Te explico por qué no 🚩'},
  ]},
...
{ id:'06_errores_checklist', wk:2, fmt:'Carrusel', day:'Sáb 27 sep', date:'2026-09-27',
  ...
  tags:'#PrimeraPropiedad #ComprarEnCórdoba #Inmobiliaria #Checklist #NLZestudio',
  cta:'Guardá · DM "quiero comprar"',
  slides:[
    {t:'coverphoto', box:['Comprás tu','primera propiedad.'], cta:'Guardá esta checklist →'},
    {t:'stmt', num:'01', big:['Presupuesto real.'], post:'Sumá los gastos de escritura.'},
    {t:'stmt', num:'02', big:['Pedí la matrícula','y verificá titularidad.']},
    {t:'stmt', num:'03', big:['Chequeá deudas.'], post:'Municipal, rentas, expensas.'},
    {t:'stmt', num:'04', big:['Visitá dos veces:','de día y de noche.'], color:'coral'},
    {t:'stmt', num:'05', big:['Reservá por escrito.'], post:'Nunca de palabra.'},
    {t:'final', small:['Guardala para cuando salgas a buscar.'], big:['Y la recorremos','juntos.'], box:'Escribime QUIERO COMPRAR por DM.'},
  ]},

// ===== SEMANA 3 — HISTORIAS DEL OFICIO =====
{ id:'07_historia_operacion-dificil', wk:3, fmt:'Carrusel', day:'Mar 30 sep', date:'2026-09-30',
  ...
  tags:'#HistoriasDelOficio #Martillera #Córdoba #Negociación #NLZestudio',
  cta:'"¿Te pasó algo así? Contame 👇"',
  slides:[
    {t:'coverphoto', box:['La operación más','difícil que cerré.'], cta:'No se trabó por la plata →'},
    {t:'stmt', pre:'Ninguno quería ceder.', big:['Uno sentía que','bajar era perder.']},
    {t:'stmt', pre:'El otro, que aceptar era', big:['quedar en','desventaja.'], color:'coral'},
    {t:'stmt', pre:'El problema no era el precio.', big:['Era el orgullo','de dos familias.']},
    {t:'stmt', pre:'Dejé los números de lado', big:['y escuché de qué','tenían miedo.']},
    {t:'final', small:['Cuando cada uno se sintió respetado,'], big:['el acuerdo','apareció solo.'], box:'¿Te pasó algo así? Contame en comentarios.'},
  ]},
...
{ id:'08_historia_reel-conoceme', wk:3, fmt:'Reel', day:'Jue 02 oct', date:'2026-10-02',
  ...
  tags:'#Conoceme #Martillera #Córdoba #DetrásDeEscena #NLZestudio',
  cta:'Presentate en comentarios · DM abierto',
  ...
  slides:[
    {t:'reelhook', big:['Nadie sueña con','ser martillera.'], sub:'Yo tampoco. Te cuento por qué elegí esto 👇'},
  ]},
...
{ id:'09_historia_venta-caida', wk:3, fmt:'Carrusel', day:'Sáb 04 oct', date:'2026-10-04',
  ...
  tags:'#HistoriasDelOficio #SeguridadJurídica #Córdoba #Inmobiliaria #NLZestudio',
  cta:'DM "¿mis papeles están en regla?"',
  slides:[
    {t:'coverphoto', box:['Se me cayó una venta','a días de la firma.'], cta:'La mejor lección de mi carrera →'},
    {t:'stmt', pre:'Apareció una deuda', big:['que nadie','había declarado.']},
    {t:'stmt', pre:'El comprador se bajó.', big:['Me','dolió.'], color:'coral'},
    {t:'stmt', pre:'Pero aprendí algo', big:['que hoy es','mi obsesión.']},
    {t:'stmt', pre:'Ninguna operación mía avanza sin', big:['la carpeta','impecable.']},
...
{ id:'10_jugada_usd100k', wk:4, fmt:'Carrusel', day:'Mar 07 oct', date:'2026-10-07',
  ...
  tags:'#Córdoba #Inversión #DólarInmobiliario #ComprarEnCórdoba #NLZestudio',
  cta:'DM con tu presupuesto',
  slides:[
    {t:'covertext', kicker:'NLZ · CÓRDOBA', big:['Con USD 100.000'], big2:['¿qué comprás?'], cta:'Deslizá →'},
    {t:'stmt', label:'Miami', big:['Un monoambiente','lejos del mar.']},
    {t:'stmt', label:'Buenos Aires', big:['2 ambientes en','barrio medio.']},
    {t:'stmt', label:'Córdoba', big:['2 o 3 amb.','con cochera.'], color:'coral', post:'En buena zona.'},
    {t:'stmt', label:'Sierras', big:['Una casa','con patio.']},
    {t:'final', small:['En Córdoba tu dólar todavía rinde.'], big:['Pero la ventana','no es eterna.'], box:'Mandame tu presupuesto y te armo opciones.'},
  ]},
...
{ id:'11_jugada_reel-comprar-alquilar', wk:4, fmt:'Reel', day:'Jue 09 oct', date:'2026-10-09',
  ...
  tags:'#ComprarVsAlquilar #Córdoba #FinanzasPersonales #Inmobiliaria #NLZestudio',
  cta:'DM "mi cuenta" · link en bio',
  ...
  slides:[
    {t:'reelhook', big:['¿Compro o','sigo alquilando?'], sub:'Los números, sin vueltas 👇'},
  ]},
...
{ id:'12_jugada_cierre', wk:4, fmt:'Carrusel', day:'Sáb 11 oct', date:'2026-10-11',
  ...
  tags:'#DecidirConNLZ #Córdoba #Inmobiliaria #Tasación #NLZestudio',
  cta:'DM "DECIDO" → agenda de tasación',
  slides:[
    {t:'covertext', kicker:'TEMPORADA DE DECISIONES', big:['Todo el mes','lo pensaste.'], big2:['Este es el mensaje.']},
    {t:'stmt', pre:'Si querés vender:', big:['te taso','sin cargo.']},
    {t:'stmt', pre:'Si querés comprar:', big:['armamos tu búsqueda','con criterio.']},
    {t:'stmt', pre:'Si solo querés entender el mercado:', big:['también.','Sin compromiso.'], color:'coral'},
...
.big{font-family:"Fraunces",Georgia,serif;font-weight:900;font-size:104px;line-height:1.0;letter-spacing:-.02em;color:var(--verde)}
.big.coral{color:var(--coral)}
.lead{font-family:"Fraunces",serif;font-weight:900;font-size:88px;line-height:1.02;letter-spacing:-.02em;color:var(--verde)}
.num{font-family:"Fraunces",serif;font-weight:900;font-size:130px;line-height:.8;color:var(--coral);margin-bottom:8px}
.label{font-weight:700;text-transform:uppercase;letter-spacing:.16em;font-size:30px;color:var(--coral);margin-bottom:18px}
...
.boxes{display:flex;flex-direction:column;gap:20px;align-items:flex-start;margin-top:14px}
.boxes span{background:var(--verde);color:var(--crema);font-family:"Fraunces",serif;font-weight:700;font-size:52px;padding:12px 26px;border-radius:8px}
...
.cover .grad{position:absolute;inset:0;background:linear-gradient(180deg,rgba(20,36,29,.12) 0%,rgba(20,36,29,0) 42%,rgba(20,36,29,.30) 100%)}
...
.cover .cta{background:#fff;color:var(--coral);font-family:"Fraunces",serif;font-weight:700;font-size:52px;padding:10px 20px;margin-top:12px}
.cover .wm{color:#fff}.cover .wm b{color:var(--coral)}
/* covertext */
.covertext{justify-content:center}
.covertext .big{font-size:112px}
/* reel hook */
...
.reelhook .big{font-size:104px}
.reelhook .sub{margin-top:34px;font-size:40px;color:#3a5449}
/* final verde */
...
function slideHTML(s, i, n){
  ...
  const bigcls = s.color==='coral' ? 'big coral' : 'big';
  if(s.t==='coverphoto'){
    return `<div class="board cover">
      <div class="photo" style="background-image:url('${COVER}')"></div><div class="grad"></div>
      ${wm}${cnt}
      <div class="stack"><span class="cb">${lines(s.box)}</span><span class="cta">${H(s.cta)}</span></div>
    </div>`;
  }
  if(s.t==='covertext'){
    return `<div class="board cream covertext">${wm}${cnt}
      ${s.kicker?`<div class="kicker">${H(s.kicker)}</div>`:''}
      <div class="big">${lines(s.big)}</div>
      ${s.big2?`<div class="big coral">${lines(s.big2)}</div>`:''}
      ${s.cta?`<div class="post small">${H(s.cta)}</div>`:''}
    </div>`;
  }
  if(s.t==='reelhook'){
    return `<div class="board reelhook"><div class="tag">REEL</div>
      <div class="wm" style="top:auto;bottom:56px">NL<b>Z</b> ESTUDIO</div>
      <div class="big">${lines(s.big)}</div>
      <div class="sub">${H(s.sub)}</div>
    </div>`;
  }
  if(s.t==='boxes'){
    return `<div class="board cream">${wm}${cnt}
      <div class="pre">${H(s.pre)}</div>
      <div class="boxes">${s.items.map(x=>`<span>${H(x)}</span>`).join('')}</div>
    </div>`;
  }
  if(s.t==='final'){
    return `<div class="board final">${wm}${cnt}
      ${(s.small||[]).map(x=>`<div class="small">${H(x)}</div><div class="gap"></div>`).join('')}
      <div class="big">${lines(s.big)}</div>
      <div class="gap"></div><div class="gap"></div>
      <div><span class="fbox">${H(s.box)}</span></div>
      <div class="brand">NL<b>Z</b> ESTUDIO<span>@NATI_LUQUEZAMPIERI · CÓRDOBA</span></div>
    </div>`;
  }
  // stmt
  return `<div class="board cream">${wm}${cnt}
    ${s.num?`<div class="num">${H(s.num)}</div>`:''}
    ${s.label?`<div class="label">${H(s.label)}</div>`:''}
    ${s.pre?`<div class="pre">${H(s.pre)}</div>`:''}
    <div class="${bigcls}">${lines(s.big)}</div>
